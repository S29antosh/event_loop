...
const EventPage = () => {
  ...
  return (
    <>
      ...
      <div className="productcontainer flex items-center justify-center">
        <div className="productbox">
          ...
          <div className="flex items-center last-min w-[800px]	">
            <img
              ...
              src={`https://source.unsplash.com/500x600/?event`}
              alt="productImage"
            />
          </div>
          {/* )} */}
          ...
          <div className="prodinfo">
            <div className="prod-box">
              ...
              <p className="prod-bhitra">{dummyData[0].name}</p>
            </div>
            <div className="prod-box">
              <p className="prod-title">Price</p>
              <p className="prod-bhitra">{dummyData[0].price}</p>
            </div>
            <div className="prod-box">
            ...
            <button
              type="button"
              className="h-20 w-40 border-slate-900 rounded-lg bg-green-100 hover:cursor-pointer text-lg font-medium flex items-center justify-center mt-5"
              onClick={() => {
                // postRating();
              }}
            >
